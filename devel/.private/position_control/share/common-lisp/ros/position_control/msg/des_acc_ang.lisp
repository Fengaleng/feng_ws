...
(cl:defmethod cl:initialize-instance :after ((m <des_acc_ang>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'des_acc_ang)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name position_control-msg:<des_acc_ang> is deprecated: use position_control-msg:des_acc_ang instead.")))
...
(cl:defmethod accel_out-val ((m <des_acc_ang>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:accel_out-val is deprecated.  Use position_control-msg:accel_out instead.")
  (accel_out m))

(cl:ensure-generic-function 'ang_vel_out-val :lambda-list '(m))
(cl:defmethod ang_vel_out-val ((m <des_acc_ang>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:ang_vel_out-val is deprecated.  Use position_control-msg:ang_vel_out instead.")
  (ang_vel_out m))
