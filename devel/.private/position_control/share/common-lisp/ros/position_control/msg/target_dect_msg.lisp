...
(cl:defmethod cl:initialize-instance :after ((m <target_dect_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'target_dect_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name position_control-msg:<target_dect_msg> is deprecated: use position_control-msg:target_dect_msg instead.")))
...
(cl:defmethod jerk_ref-val ((m <target_dect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:jerk_ref-val is deprecated.  Use position_control-msg:jerk_ref instead.")
  (jerk_ref m))

(cl:ensure-generic-function 'snap_ref-val :lambda-list '(m))
(cl:defmethod snap_ref-val ((m <target_dect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:snap_ref-val is deprecated.  Use position_control-msg:snap_ref instead.")
  (snap_ref m))
...
(cl:defmethod speed-val ((m <target_dect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:speed-val is deprecated.  Use position_control-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'collide_state-val :lambda-list '(m))
(cl:defmethod collide_state-val ((m <target_dect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader position_control-msg:collide_state-val is deprecated.  Use position_control-msg:collide_state instead.")
  (collide_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<target_dect_msg>)))
  ...
  "position_control/target_dect_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'target_dect_msg)))
  "Returns string type for a message object of type 'target_dect_msg"
  "position_control/target_dect_msg")
