...
if("TRUE" STREQUAL "TRUE")
  set(traj_gen_SOURCE_PREFIX /home/fechec/feng_ws/src/traj_gen)
  set(traj_gen_DEVEL_PREFIX /home/fechec/feng_ws/devel/.private/traj_gen)
  set(traj_gen_INSTALL_PREFIX "")
  set(traj_gen_PREFIX ${traj_gen_DEVEL_PREFIX})
else()
  set(traj_gen_SOURCE_PREFIX "")
  set(traj_gen_DEVEL_PREFIX "")
  set(traj_gen_INSTALL_PREFIX /home/fechec/feng_ws/install)
...
if(NOT "/home/fechec/feng_ws/devel/.private/traj_gen/include;/home/fechec/feng_ws/src/traj_gen/include;/usr/include/eigen3 " STREQUAL " ")
  set(traj_gen_INCLUDE_DIRS "")
  set(_include_dirs "/home/fechec/feng_ws/devel/.private/traj_gen/include;/home/fechec/feng_ws/src/traj_gen/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'traj_gen' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fechec/feng_ws/src/traj_gen/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fechec/feng_ws/devel/.private/traj_gen/lib;/home/fechec/feng_ws/devel/lib;/opt/ros/melodic/lib)
...
set(traj_gen_EXPORTED_TARGETS "traj_gen_generate_messages_cpp;traj_gen_generate_messages_eus;traj_gen_generate_messages_lisp;traj_gen_generate_messages_nodejs;traj_gen_generate_messages_py;traj_gen_gencfg")
...
set(depends "dynamic_reconfigure;geometry_msgs;mav_msgs;nav_msgs;roscpp;sensor_msgs;trajectory_msgs;message_generation;std_msgs;geometry_msgs")
