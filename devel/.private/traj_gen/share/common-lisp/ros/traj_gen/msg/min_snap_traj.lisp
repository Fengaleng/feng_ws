...
(cl:defmethod cl:initialize-instance :after ((m <min_snap_traj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'min_snap_traj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traj_gen-msg:<min_snap_traj> is deprecated: use traj_gen-msg:min_snap_traj instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:header-val is deprecated.  Use traj_gen-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'position_ref-val :lambda-list '(m))
(cl:defmethod position_ref-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:position_ref-val is deprecated.  Use traj_gen-msg:position_ref instead.")
  (position_ref m))

(cl:ensure-generic-function 'velocity_ref-val :lambda-list '(m))
(cl:defmethod velocity_ref-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:velocity_ref-val is deprecated.  Use traj_gen-msg:velocity_ref instead.")
  (velocity_ref m))

(cl:ensure-generic-function 'accel_ref-val :lambda-list '(m))
(cl:defmethod accel_ref-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:accel_ref-val is deprecated.  Use traj_gen-msg:accel_ref instead.")
  (accel_ref m))

(cl:ensure-generic-function 'yaw_ref-val :lambda-list '(m))
(cl:defmethod yaw_ref-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:yaw_ref-val is deprecated.  Use traj_gen-msg:yaw_ref instead.")
  (yaw_ref m))

(cl:ensure-generic-function 'launch_flag-val :lambda-list '(m))
(cl:defmethod launch_flag-val ((m <min_snap_traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traj_gen-msg:launch_flag-val is deprecated.  Use traj_gen-msg:launch_flag instead.")
  (launch_flag m))
